...
<div id="video-div">
  <?php $oct_key12 = get_post_meta($post->ID, 'oct_key12', true); if ($oct_key12) { ?><?php echo $oct_key12; ?><?php } else { ?>
    <iframe width="640" height="360" src="//www.youtube.com/embed/7bZwr2FeC_Q" frameborder="0" allowfullscreen=""></iframe>
  <?php } ?>
</div>
