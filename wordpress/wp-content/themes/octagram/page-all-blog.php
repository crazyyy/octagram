...
<a style="background: #00468c; padding: 5px 15px; font-size: 11px; color: #fff; border-radius: 5px;text-decoration: none;" href="<?php the_permalink() ?>" rel="bookmark"><?php _e('Read more', 'octa'); ?></a></a><br><br><br>
<?php endwhile; ?>
</div> 
<div class="clear"></div>
<?php get_footer(); ?>
