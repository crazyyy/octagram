<?php get_header(); ?>
  <div class="row">
    <div class="breadcrumbs col-md-12" xmlns:v="http://rdf.data-vocabulary.org/#">
      ...
      <span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" title="Дилер" href="<?php echo home_url(); ?>/mydiler/"><?php _e('Dealers', 'octa'); ?></a></span> &gt;
              ...
              <div class="col-md-7 mydiler-description">
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo home_url(); ?>/mydiler/"><?php _e('dealer', 'octa'); ?></a>
                    </td>
                  </tr>
                </table>
