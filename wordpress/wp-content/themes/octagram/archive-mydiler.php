...
<div class="row">
    ...
    <article class="content-container col-md-9">
      <div id="right-content">
        ...
        <div class="row content-tab-header">
          <div class="col-md-3 content-tab-left">
            <a href="<?php bloginfo('url'); ?>/install/">
              <?php _e('Installer', 'octa'); ?>
            </a>
          </div><!-- content-tab-left -->
          <div class="col-md-3 content-tab-right content-tab-active">
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/js/archive-mydiler.js"></script>
<?php get_footer(); ?>
