...
<span typeof="v:Breadcrumb"><?php _e('Dealers', 'octa'); ?></span></div>
...
<?php 
$page_id = 2155; // 123 should be replaced with a specific Page's id from your site, which you can find by mousing over the link to edit that Page on the Manage Pages admin page. The id will be embedded in the query string of the URL, e.g. page.php?action=edit&post=123.
...
border-top-right-radius: 10px;"><a style="color: #393635;cursor: context-menu; font-size:16px; font-weight:bold;text-decoration: none;" href="http://www.octagram.ru/mydiler/"><?php _e('Dealers', 'octa'); ?></a></div>
...
<div style="width: 90px; height: 90px; padding:20px;display:block;float:left;"><img style="border-radius: 10px;" src="<?php the_field('фотодилера'); ?>" alt="<?php the_title(); ?>"  width="90" height="90"  /></div>
