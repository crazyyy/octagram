  ...
  function uajax_result($arg, $id,$pagenumber,$getdata){
	...
	if ( $query->have_posts() ) {
	   while ( $query->have_posts() ) {
				...
				<div style="width: 85px; height: 70px; padding: 10px 0px 10px 0;display:block;float:left;"><img style="border-radius: 10px;" src="<?php the_field('фотодилера'); ?>" alt="<?php the_title(); ?>"  width="85" /></div>
<div style="width: 190px;margin-left: 10px; height: 150px; display:block;float:left;padding-top:10px;">
...
if( $value == 1 )
{ ?><img src="http://octagram.ru/wp-content/uploads/2014/10/1.png" style="margin-left:-10px;" width="101" height="26" border="0" alt=""><?php 
}
elseif( $value == 2 )
{ ?><img src="http://octagram.ru/wp-content/uploads/2014/10/2.png" style="margin-left:-10px;" width="101" height="26" border="0" alt=""><?php 
}
elseif( $value == 3 )
{ ?><img src="http://octagram.ru/wp-content/uploads/2014/10/3.png" style="margin-left:-10px;" width="101" height="26" border="0" alt=""><?php 
}
elseif( $value == 4 )
{ ?><img src="http://octagram.ru/wp-content/uploads/2014/10/4.png" style="margin-left:-10px;" width="101" height="26" border="0" alt=""><?php 
}
elseif( $value == 5 )
{ ?><img src="http://octagram.ru/wp-content/uploads/2014/10/5.png" style="margin-left:-10px;" width="101" height="26" border="0" alt=""><?php 
}
else
{ ?> <?php 
}
?><br>
<a href="<?php the_permalink();?>" title="подробнее" style="color:#00468c; font-size: 10px;text-transform: uppercase;text-decoration: none;float: right; text-align: right; display: block;">подробнее</a></div>
