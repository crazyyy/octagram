		 ...
		 if($type == 'dropdown'){
			...
			if(!empty($taxall)){
				$html .= '<option selected value="uwpqsftaxoall">'.$taxall.'</option>';
					...
					$html .= '<option style="height:45px !important; border-bottom: 1px solid #034281  !important; font-size: 16px !important; padding: 20px 0 !important;" value="'.$term->slug.'" '.$selected.'>'.$term->name.'</option>';}
			}				
			$html .= '</select>';
			$html .= '</div>';
