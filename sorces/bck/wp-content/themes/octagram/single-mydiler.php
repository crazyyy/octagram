...
<span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" title="Дилер" href="http://www.octagram.ru/mydiler/"><?php _e('Dealers', 'octa'); ?></a></span> &gt; 
...
<div style="width: 45%; padding: 0 20px;float: left; display:block;position: relative; ">
<?php  $val = get_field( "Iframe" );
if( $val )
{ ?>
