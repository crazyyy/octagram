...
function replace_footer_version() { return ''; }
...
register_sidebar(array('id'=>'sidebar-1','name'=>'Сайдбар', 
		'before_widget' => '<div>',
		'after_widget' => '</div>',
...
register_sidebar(array('id'=>'sidebar-2','name'=>'Сайдбар новостей', 
		'before_widget' => '<div>',
		'after_widget' => '</div>',
		'before_title' => '<div class="footerfid">',
		'after_title' => '</div>',
	...
	register_sidebar(array('id'=>'sidebar-3','name'=>'Сайдбар клиентов', 
		'before_widget' => '<div>',
		'after_widget' => '</div>',
		'before_title' => '<div class="footerfid">',
		'after_title' => '</div>',
	...
	register_sidebar(array('id'=>'sidebar-4','name'=>'Сайдбар Документация', 
		'before_widget' => '<div>',
		'after_widget' => '</div>',
		'before_title' => '<div class="footerfid">',
		'after_title' => '</div>',
		...
		register_sidebar(array('id'=>'sidebar-5','name'=>'Диллер\установщик 1-3', 
		'before_widget' => '<div>',
		'after_widget' => '</div>',
		'before_title' => '<div class="footerfid">',
		'after_title' => '</div>',
		...
		register_sidebar(array('id'=>'sidebar-6','name'=>'Диллер\установщик 2-3', 
		'before_widget' => '<div>',
		'after_widget' => '</div>',
		'before_title' => '<div class="footerfid">',
		'after_title' => '</div>',
		...
		register_sidebar(array('id'=>'sidebar-7','name'=>'Диллер\установщик 3-3', 
		'before_widget' => '<div>',
		'after_widget' => '</div>',
		'before_title' => '<div class="footerfid">',
		'after_title' => '</div>',
